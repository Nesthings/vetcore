      ...
      <main className="space-y-6 p-4">
        ...
        <Card className="shadow-card">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
              <Phone className="size-4 text-primary" aria-hidden="true" /> Dueño
            </CardTitle>
          </CardHeader>
        ...
        <Card className="border-warning/40 shadow-card">
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Agrega información que el veterinario debe conocer (alergias, comportamiento, etc.)
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card className="shadow-card">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-base">
              <Syringe className="size-4 text-primary" aria-hidden="true" /> Carnet de vacunación
            </CardTitle>
            <CardDescription>
